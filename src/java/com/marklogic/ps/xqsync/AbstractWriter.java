...
public abstract class AbstractWriter implements WriterInterface {
    ...
    public AbstractWriter(Configuration _configuration)
        ...
        rolesExecute = configuration.getRolesExecute();
        rolesInsert = configuration.getRolesInsert();
        rolesRead = configuration.getRolesRead();
        rolesUpdate = configuration.getRolesUpdate();
